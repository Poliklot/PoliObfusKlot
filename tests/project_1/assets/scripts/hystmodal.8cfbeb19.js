!function (e) {
  ...
  i.m = e, i.c = t, i.d = function (e, t, n) {
    ...
    if (i.r(n), Object.defineProperty(n, 'rv', {
      enumerable: !0,
      value: e
      ...
      return t = e, (i = [{
        ...
        value: function () {
          document.addEventListener("click", function (e) {
            ...
            if (!this._isMoved && t) {
              ...
              var i = this.starter.getAttribute(this.config.linkAttributeName);
              return this._nextWindows = document.querySelector(i), void this.open();
            }
            ...
            !this._isMoved && e.target instanceof Element && !e.target.classList.contains('lz') || (this._overlayChecker = !0);
          }.bind(this)), document.addEventListener("mouseup", function (e) {
            if (!this._isMoved && e.target instanceof Element && this._overlayChecker && e.target.classList.contains('lz')) return e.preventDefault(), this._overlayChecker, void this.close();
        ...
        value: function (t) {
          if (t && (this._nextWindows = "string" == typeof t ? document.querySelector(t) : t), this._nextWindows) {
            ...
            this.openedWindow = this._nextWindows, this._modalBlock = this.openedWindow.querySelector('.l0'), this.config.beforeOpen(this), this._bodyScrollControl(), e._shadow.classList.add('lu--show'), this.openedWindow.classList.add('lw--rh'), this.openedWindow.setAttribute("aria-hidden", "false"), this.config.catchFocus && this.focusContol(), this.isOpened = !0;
          } else console.log("Warinig: hustModal selector is not found");
        }
      }, {
        key: "close",
        value: function () {
          this.isOpened && (this.config.waitTransitions ? (this.openedWindow.classList.add('lw--moved'), this._isMoved = !0, this.openedWindow.addEventListener("transitionend", this._closeAfterTransition), this.openedWindow.classList.remove('lw--rh')) : (this.openedWindow.classList.remove('lw--rh'), this._closeAfterTransition()));
        }
      }, {
        key: "_closeAfterTransition",
        value: function () {
          this.openedWindow.classList.remove('lw--moved'), this.openedWindow.removeEventListener("transitionend", this._closeAfterTransition), this._isMoved = !1, e._shadow.classList.remove('lu--show'), this.openedWindow.setAttribute("aria-hidden", "true"), this.config.catchFocus && this.focusContol(), this._bodyScrollControl(), this.isOpened = !1, this.openedWindow.scrollTop = 0, this.config.afterClose(this), this._reopenTrigger && (this._reopenTrigger = !1, this.open());
        }
      }, {
        key: "focusContol",
        value: function () {
        ...
        value: function () {
          if (this.config.backscroll) {
            ...
            if (!0 === this.isOpened) return t.classList.remove('lt'), t.style.marginRight = "", e.map(function (e) {
              e.style.marginRight = "";
            }), window.scrollTo(0, this._scrollPosition), void (t.style.top = "");
            this._scrollPosition = window.pageYOffset;
            var i = window.innerWidth - t.clientWidth;
            t.style.top = -this._scrollPosition + 'r4', i && (t.style.marginRight = i + 'r4', e.map(function (e) {
              e.style.marginRight = parseInt(getComputedStyle(e).marginRight) + i + 'r4';
            })), t.classList.add('lt');
          }
        }
      }]) && o(t.prototype, i), e;
