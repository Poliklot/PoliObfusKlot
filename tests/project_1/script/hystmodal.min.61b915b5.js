      ...
      return t = e, (n = [{
        ...
        value: function () {
          document.addEventListener("click", function (e) {
            ...
            !this._isMoved && e.target instanceof Element && !e.target.classList.contains("modal__wrap") || (this._overlayChecker = !0);
          }.bind(this)), document.addEventListener("mouseup", function (e) {
            if (!this._isMoved && e.target instanceof Element && this._overlayChecker && e.target.classList.contains("modal__wrap")) return e.preventDefault(), this._overlayChecker, void this.close();
        ...
        value: function (t) {
          if (t && (this._nextWindows = "string" == typeof t ? document.querySelector(t) : t), this._nextWindows) {
            ...
            this.openedWindow = this._nextWindows, this._modalBlock = this.openedWindow.querySelector(".modal__window"), this.config.beforeOpen(this), this._bodyScrollControl(), e._shadow.classList.add("modal__shadow--show"), this.openedWindow.classList.add("modal--active"), this.openedWindow.setAttribute("aria-hidden", "false"), this.config.catchFocus && this.focusContol(), this.isOpened = !0;
          } else console.log("Warinig: hustModal selector is not found");
        }
      }, {
        key: "close",
        value: function () {
          this.isOpened && (this.config.waitTransitions ? (this.openedWindow.classList.add("modal--moved"), this._isMoved = !0, this.openedWindow.addEventListener("transitionend", this._closeAfterTransition), this.openedWindow.classList.remove("modal--active")) : (this.openedWindow.classList.remove("modal--active"), this._closeAfterTransition()));
        }
      }, {
        ...
        value: function () {
          if (this.config.backscroll) {
            ...
            if (!0 === this.isOpened) return t.classList.remove("modal__opened"), t.style.marginRight = "", e.map(function (e) {
              e.style.marginRight = "";
...
/******/ })()
;
//# sourceMappingURL=hystmodal.min.61b915b5.js.map